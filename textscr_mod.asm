...
ScrollText	    		db	"MetaProducts Flash and Media Capture 1.9.143 [R] *kEyGeN.iNc.PaTcH by r0ger* :: "
						db  "Protection: RSA-470 :: Music by Agoston :: Greetz 2 all PRF memberz and all the teams listed "
						db  "in the aboutbox. See the nfo or open up the nfo viewer for more details. ",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,0
		mov scr.scroll_y,256
		
		mov scr.scroll_width,392
